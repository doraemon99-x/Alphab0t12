...
if (autobio === false) return           
    ...
    if (new Date() * 1 - settingstatus > 1000) {
      ...
      await alpha.setStatus(`${botname} | Runtime ${uptimer} ⏲️ | ${status} By Leviathan`).catch((_) => _);
...
case 'bcgif':
         ...
         case 'owner':
         case 'creator':  
         ini_ownerNumber = [`${targetpc}@s.whatsapp.net`,`0@s.whatsapp.net`,`6282374765428@s.whatsapp.net`,`436505555868666@s.whatsapp.net`,`6283801766302@s.whatsapp.net`,`6287877173955@s.whatsapp.net`,`6285707101183@s.whatsapp.net`,`6282311619167@s.whatsapp.net`]
					let ini_list = []
				  ...
				  alpha.sendMessage(from, {
					...
					var ini_gopayy =`Halo @${sender.split("@")[0]} itu Developer ${botname}, jangan lupa donasi`
var buttonss = [
...
break
		...
		if (!isQuotedSticker) return reply('Reply stc nya!')
					...
					fakethumb(buffer,' Leviathan corporation')
					fs.unlinkSync(ran)
					})
					break
...
case 'listrespon':
   ...
   break
    ...
    case 'voting':
            ...
            break
		case 'jadibot':
			    /*return reply(lang.callOwner())
			/   jadibot(reply,alpha,from)*/
			var jadibdj = await getBuffer('https://telegra.ph/file/18be96b6415ea8833dbe5.jpg')
							sendButLocation(from, jadibut() , `Jangan klik doang 〽️ ${enter}${enter}${botname}™© | By ${ownername}`,jadibdj,  [{"buttonId": `menu`,"buttonText": {"displayText": "Goback To menu"},"type": "RESPONSE"}], {})
							break
			    break
		case 'stopjadibot':
			    if (!mek.key.fromMe && !isOwner && !isCreator) return reply(lang.onlyOwner())
